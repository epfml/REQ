...
from .transforms_factory import create_transform, create_transform_from_dict
...
def create_loader(
    ...
    if overwrite_transforms:
        # Overwrites all the parameters used below
        transform = create_transform_from_dict(overwrite_transforms)
    else:
