...
class OptimizationConfig(FairseqDataclass):
    ...
    weight_decay_zero_bias: bool = field(
        default=True,
        metadata={
            "help": "if set, does not include biases, gains, and embeddings in weight decay."
            " (default is to set weight decay 0 for biases, gains, and embeddings)."
        },
    )
