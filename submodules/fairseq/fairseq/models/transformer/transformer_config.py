...
class TransformerConfig(FairseqDataclass):
    ...
    linear_cfg: Optional[str] = field(
        default='standard',
        metadata={"help": "Linear factory cfg"}
    )

    norm_cfg: Optional[str] = field(
        default='layer_norm',
        metadata={"help": "Norm factory cfg"}
    )

    functional_cfg: Optional[str] = field(
        default='torch',
        metadata={"help": "Custom functions"}
    )

    loss_functional_cfg: Optional[str] = field(
        default='torch',
        metadata={"help": "Custom functions used for the loss computation"}
    )
