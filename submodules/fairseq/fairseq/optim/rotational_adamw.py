...
class FairseqrotationalAdamW(FairseqOptimizer):
    ...
    def __init__(self, cfg: FairseqRotationalAdamWConfig, params):
        super().__init__(cfg)
        self._optimizer = RotationalAdamW(params, **self.optimizer_config)
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                if len(state) == 0:
                    ...
                    state['scale_invariance'] = scale_invariance
                ...
                state['velocity_gradient_alignment'] = F.cosine_similarity(grad.reshape(grad.shape[0], -1), exp_avg.reshape(exp_avg.shape[0], -1), dim=1).detach()
