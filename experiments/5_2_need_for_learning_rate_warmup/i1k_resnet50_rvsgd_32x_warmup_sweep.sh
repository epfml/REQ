...
do
    ...
    do
        ...
        -b 256 --local-accumulation 32 --opt rvwrapper --opt-kwargs "inner_type=sgdm" "etar_func=sgdm" --lr $lr --momentum 0.9 --weight-decay 1e-4 --sched cosine --sched-on-update --epochs 10 --warmup-lr 1e-6 --min-lr 1e-5 --warmup-epochs 1 --checkpoint-hist 5 \
