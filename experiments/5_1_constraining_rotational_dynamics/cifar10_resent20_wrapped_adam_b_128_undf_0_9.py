...
shell_cmd = r"""PYTHONPATH=$PYTHONPATH:$base_dir torchrun --nproc_per_node 1 train.py --output $output_dir \
    ...
    --model cifar_resnet --model-kwargs name="cifar_rn20"  -b $b --opt rvwrapper --opt-kwargs 'inner_type=adam' 'etar_func=adamw' 'update_norm_decay_factor=0.9' \
    ...
    --log-wandb --wandb-kwargs project=adam-wrapper-runs name="\"rn20_udf_0_9_rvwrapper_b_${b}_iter_${iter}_lr${lr}_wd${wd}_seed${seed}\"" --seed $seed \
