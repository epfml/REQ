...
shell_cmd = r"""CUDA_VISIBLE_DEVICES=0 PYTHONPATH=$PYTHONPATH:$base_dir fairseq-train  \
    ...
    --optimizer rvwrapper --wrapper-inner-type adamw --wrapper-etar-func adamw --wrapper-hyper-parameters '{"betas" : [0.9, 0.98] }' --clip-norm 0.0 \
    ...
    --max-update 22021 \
    --save-dir runs/fairseq_adamw_rvwrapper_${cf_linear}_wd_${wd//./_}_lr_${lr//./_}_seed_${seed//./_} \
    --amp \
