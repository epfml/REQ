...
shell_cmd = r"""PYTHONPATH=$PPATH:$base_dir torchrun --nproc_per_node 1 src/main.py \
    --wandb --wandb_project lr-wd-trade-off --wandb_run_prefix llm_standard_adamw_iter_${iter}_lr${lr}_wd${wd}_seed${seed}  \
...
def main():
    base_dir = os.getcwd()
    lrs = [ 0.00027 , 0.00083, 0.0025, 0.005, 0.01, 0.03, 0.09 ]
    seeds = [ 0 , 1 , 2 ]
