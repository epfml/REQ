    ...
    do
        ...
        do
            ...
            do 
                ...
                " --iterations 15000 --warmup_percent 0.02 --opt rvadamw --lr $learning_rate --is-test-split --opt-kwargs \"betas=(0.9,0.95) weight_decay=$weight_decay\" " \
                ...
                " --wandb --wandb_project llm-sweep-4-2-section --wandb_run_prefix $wand_name  " \
                " --n_embd 768 --n_head 12 --n_layer 12 --batch_size 55 --sequence_length 512 --acc_steps 3 --dropout 0.2 " \
                " --iterations 15000 --warmup_percent 0.02 --opt rvadamw --lr $learning_rate --is-test-split " \
