...
-b 256 --opt rvsgd --lr 0.1 --momentum 0.9 --weight-decay 1e-4 --sched cosine --sched-on-update --epochs 90 --warmup-lr 1e-6 --min-lr 1e-5 --warmup-epochs 1 --checkpoint-hist 5 \
--log-wandb --wandb-kwargs project=4-2-constraining-smd name=rn50_i1k_rvsgd_zero_init_${seed} --log-wandb-extended --seed $seed