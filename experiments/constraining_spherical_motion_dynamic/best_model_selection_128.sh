...
learning_rates3=(0.05 0.5 0.0005 0.05 0.5 0.0005)
optimizers=("rvadamw" "rvsgd" "rvlion" "adamw" "sgd" "lion")
...
do
    ...
    do
        for idx in "${!values1[@]}"; do
            ...
            " -b $bath_size --opt $optimizer --momentum 0.9 --lr-base $learning_rate --lr-base-size 128 --lr-base-scale linear --weight-decay $weight_decay --sched cosine --sched-on-update --epochs 200 --warmup-lr 1e-6 --min-lr 1e-5 --warmup-epochs 5 --checkpoint-hist 1" \
