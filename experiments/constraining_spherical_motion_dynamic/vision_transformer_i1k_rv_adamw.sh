...
--drop-path 0.1 -b 1024 --opt rvadamw --lr 5e-4 --lr-base-size 512 --opt-eps 1e-8 --weight-decay 0.05 --sched cosine --sched-on-update --epochs 300 \
--warmup-lr 1e-6 --min-lr 1e-5 --warmup-epochs 5 \
--log-wandb --wandb-kwargs project=4-2-constraining-smd name=deit_tiny_i1k_rvadamw_base_${seed} --log-wandb-extended --seed $seed