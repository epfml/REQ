...
-b $b --opt adam --lr $lr --weight-decay $wd --sched cosine --sched-on-update --epochs 200 --warmup-lr 1e-6 --min-lr 1e-5 --warmup-epochs 0 --checkpoint-hist 1 \
--log-wandb --wandb-kwargs project=adam_vs_adamw name="\"rn18_adam_iter${iter}_lr${lr}_wd${wd}_seed${seed}\"" --seed $seed
"""
...
def main():
    ...
    wds = [0] + [1e-3 * 2**i for i in range(-5, 5)]
