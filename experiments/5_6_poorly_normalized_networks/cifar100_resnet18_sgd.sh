# C100 RN18 LN with SGD, sweep lr
BASE_DIR=$(pwd)
...
do
    ...
    do
        ...
        --data-dir $DATA_SET_DIR --dataset torch/CIFAR100 --dataset-download --num-classes 100 --pin-mem --input-size 3 32 32 --mean 0.5071 0.4867 0.4408 --std 0.2675 0.2565 0.2761 --smoothing 0.0 --train-split "train[:0.9]-$seed" --val-split "train[0.9:]-$seed" \
        ...
        --log-wandb --wandb-kwargs project=poor_norm name="\"c100-val-rn18-b256-ln-sgd-lr$lr-s$seed\"" 'tags=["c100_val_rn18_b256_ln_sgd_sweep_lr"]' --seed $seed
    done
done
