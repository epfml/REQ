...
--model cifar_resnet --model-kwargs 'input_block=cifar' 'block_name=basicblock' 'stage_depths=[2,2,2,2]' norm_cfg="{\"subtype\":\"gn\",\"dkwargs\":{\"G\":1}}" conv_cfg="{\"subtype\":\"wsconv2d\",\"dkwargs\":{\"gain\":False}}" linear_cfg="{\"subtype\":\"wslinear\",\"dkwargs\":{\"gain\":False}}" \
...
--log-wandb --wandb-kwargs project=req_iclr_rnln name="\"c100-val-rn18-wsln-sgdm-wd$wd-s$seed-idx$idx\"" 'tags=["c100_val_rn18_wsln_sgdm_sweep_lr"]' --seed $seed \
